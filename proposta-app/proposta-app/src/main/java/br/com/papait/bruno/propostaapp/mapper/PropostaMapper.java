...
public interface PropostaMapper {
  ...
  @Mapping(target = "valorSolicitadoFmt", expression = "java(setValorSolicitadoFmt(propostaEntity))")
  ...
  default String setValorSolicitadoFmt(PropostaEntity propostaEntity) {
    return NumberFormat.getCurrencyInstance().format(propostaEntity.getValorSolicitado());
  }
}
